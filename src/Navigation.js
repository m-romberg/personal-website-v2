...
function Navigation({ scrollContact, scrollProjects, scrollBio }) {
  ...
  return (
    <Navbar className="Navigation .navbar .navbar-expand{lg}" bg="light" expand="lg">
      ...
      <Nav className="me-auto">
        ...
        <Navbar.Text className="Navigation-Resume">
          <b>4.</b> <a href="/files/Resume-Jan-2023.pdf">Resume</a>
        </Navbar.Text>
        </Nav>
    </Navbar>
  );
